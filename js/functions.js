...
console.log("\n");
console.log("Expected output of findLongestWord([okay,Keilany,vowel]) is 5 "+myFunctionTest(5, ()=>findLongestWord("okay","Keilany","vowel")));
console.log("Expected output of findLongestWord([okay,Keilany,vowel]) is 5 "+myFunctionTest(3, ()=>findLongestWord("okay","Keilany","vowel")));

console.log("\n");
console.log("Expected output of filterLongWords(4,[okay,Keilany,vowel]) is [Keilany,vowel] "+myFunctionArrayTest(['Keilany','vowel'], ()=>filterLongWords(4,'okay','Keilany','vowel')));
console.log("Expected output of filterLongWords(4,[okay,Keilany,vowel]) is [Keilany,vowel] "+myFunctionArrayTest(['Keilany'], ()=>filterLongWords(4,'okay','Keilany','vowel')));
